...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import libevent_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("1080aeaf-3a6a-583e-a51c-c537b09f60ec"))
platforms = [Pkg.Artifacts.unpack_platform(e, "libevent", artifacts_toml) for e in artifacts["libevent"]]
...
if best_platform === nothing
    @debug("Unable to load libevent; unsupported platform $(triplet(platform_key_abi()))")
else
